---
title: Numerical analysis laboratory work №5
...
Newton polynomial P(x) = 0.0 + 0.07111*(x - 0.0) +
0.8*(x - 0.0)(x - 0.26667) + 1.0*(x - 0.0)(x -
0.26667)(x - 0.53333) + -0.0*(x - 0.0)(x - 0.26667)
(x - 0.53333)(x - 0.8) + 0.0*(x - 0.0)(x - 0.26667)
(x - 0.53333)(x - 0.8)(x - 1.06667) + -0.0*(x - 0.0)
...
Theoretical error of spline interpolation: 0.2844444444444458
```

![Interpolation plots](./interpolation.png)
![Errors plots](./error.png)
